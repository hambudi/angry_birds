...
E(4).Ar2 = [];
E(4).Br2 = [];
E(4).mass=20*max(E(4).A)*max(E(4).B);
...
E(5).Ar2 = [];
E(5).Br2 = [];
E(5).mass=20*max(E(5).A)*max(E(5).B);
...
E(7).Br1 = [];
E(7).Br2 = [];
E(7).mass=1*max(E(7).A)*max(E(7).B);
...
E(7).style = 3;
E(7).color =  [0 1 0];
E(7).imgdata = pigimgdata;
E(7).imgalphadata = pigalphadata;
...
E(8).Br1 = [];
E(8).Br2 = [];
E(8).mass=1*max(E(8).A)*max(E(8).B);
...
E(8).style = 31;
E(8).color =  [0 1 0];
E(8).imgdata = pigimgdata;
E(8).imgalphadata = pigalphadata;
...
E(9).Br1 = [];
E(9).Br2 = [];
E(9).mass=1*max(E(9).A)*max(E(9).B);
...
E(9).style = 31;
E(9).color =  [0 1 0];
E(9).imgdata = pigimgdata;
E(9).imgalphadata = pigalphadata;
...
E(10).Br1 = [];
E(10).Br2 = [];
E(10).mass=max(E(10).A)*max(E(10).B);
...
E(10).style = 5;
E(10).color =  [0 0 1];
E(10).imgdata = birdimgdata;
E(10).imgalphadata = birdalphadata;
...
% E(6).Br1 = [];
% E(6).Br2 = [];
% E(6).mass=10*max(E(6).A)*max(E(6).B);
% E(6).I=E(6).mass*(E(6).A(1)^2 + E(6).B(2)^2)/12;
% E(6).lvelocity = [0;0];
% E(6).alvelocity = [0;0];
% E(6).aavelocity = 0;
