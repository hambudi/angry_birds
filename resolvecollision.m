...
for i=1:len(1)
    for j = i+1:len(1)
        if (objcol(i,j)>0)||(objcol(j,i)>0)
            ...
            if E(i).style == 32 && norm(E(i).lvelocity)>45 && E(j).style ==2
                E(i).lvelocity= E(i).lvelocity/30;
                E(i).lvelocity1= E(i).lvelocity1/30;
                E = breakobject(E,j);
                killed = j;
                for derp = 2:length(E)
                    E(derp).ground = 0;
            ...
            if E(j).style == 32 && norm(E(j).lvelocity)>45 && E(i).style ==2
                E(j).lvelocity= E(j).lvelocity/30;
                E(j).lvelocity1= E(j).lvelocity1/30;
                E = breakobject(E,i);
                killed = i;
                for derp = 2:length(E)
                    E(derp).ground = 0;
            ...
            if E(i).style == 32 && norm(E(i).lvelocity)>45 && E(j).style ==4
                E(i).lvelocity= E(i).lvelocity/12;
                E(i).lvelocity1= E(i).lvelocity1/12;
                E = breakobject(E,j);
                killed = j;
                for derp = 2:length(E)
                    E(derp).ground = 0;
            ...
            if E(j).style == 32 && norm(E(j).lvelocity)>45 && E(i).style ==4
                E(j).lvelocity= E(j).lvelocity/12;
                E(j).lvelocity1= E(j).lvelocity1/12;
                E = breakobject(E,i);
                killed = i;
                for derp = 2:length(E)
                    E(derp).ground = 0;
            ...
            if (E(i).style ==32 && E(j).style ==5)
                killed = j;
                E = breakobject(E,j);
                score = score+ 75;
            elseif (E(j).style ==32 && E(i).style ==5)
                killed = i;
                E = breakobject(E,i);
            ...
            if E(i).style ==5
                if norm(E(i).lvelocity-E(j).lvelocity)>25
                    killed = i;
                    E = breakobject(E,i);
                    score = score+ 50;
                end
            elseif E(j).style ==5
                if norm(E(j).lvelocity-E(i).lvelocity)>25
                    killed = j;
                    E = breakobject(E,j);
                    score = score+ 50;
                end
