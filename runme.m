...
background = imshow(imbk, 'xdata', [0 500], 'ydata', [0 150]); hold on
[imgr map alphagr] = imread('background.png');
hold on
global badcondition
badcondition =0;

pigsbtn=uicontrol('Style','pushbutton','string','Revenge of the Pigs','Position',[515, 200, 200,50]);
physbtn=uicontrol('Style','pushbutton','string','Physics Demo','Position',[515, 75, 200,50]);
set(pigsbtn,'callback','start_callback');
set(physbtn,'callback','phys_callback');
    ...
    if badcondition ==1
        ...
        while game
            ...
            while pressed == 0 && flag ==0
                ...
                for i = 1:length(E)
                    if numel(find([E.style]==3)) == 0&& flag ==0
                        text(100,65,['YOU LOSE!!!'],'fontname', 'calibre','fontsize',50 );
            ...
            if numel(find([E.style]==5)) == 0
                ...
                text(100,35,['LEVEL 2'],'fontname', 'calibre','fontsize',50 );
